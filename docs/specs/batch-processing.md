...
| gapup-monitor / psc-monitor | `0,20,40 24 15 * * 1-5` | 平日 15:24 (00/20/40) | GU/PSC 場中スキャン → 引け成行発注 |
| us-etf-monitor | `0,20,40 24 15 * * 1-5` | 平日 15:24 (00/20/40) | 米株ETF エントリー(idle帯のみ引け成行買い) + タイムストップExit(引け成行売り) |
