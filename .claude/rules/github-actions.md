...
| スケジューラ | 用途 | 対象ジョブ |
|-------------|------|-----------|
| **cron-job.org** | 平日に毎日実行するバッチ処理 | morning-analysis, order-manager, midday-reassessment, end-of-day, ghost-review, defensive-exit-followup, unfilled-order-followup, daily-backtest |
