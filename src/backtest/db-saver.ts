...
import type { BreakoutBacktestResult, GapUpBacktestResult, MomentumBacktestResult, EarningsGapBacktestResult, WeeklyBreakBacktestResult, MaPullbackBacktestResult, GapDownReversalBacktestResult, PostSurgeConsolidationBacktestResult } from "./types";

type BacktestStrategy = "breakout" | "gapup" | "combined" | "momentum" | "earnings-gap" | "weekly-break" | "ma-pullback" | "gapdown-reversal" | "post-surge-consolidation";
...
export async function saveBacktestResult(
  result: BreakoutBacktestResult | GapUpBacktestResult | MomentumBacktestResult | EarningsGapBacktestResult | WeeklyBreakBacktestResult | MaPullbackBacktestResult | GapDownReversalBacktestResult | PostSurgeConsolidationBacktestResult,
