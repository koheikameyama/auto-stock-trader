...
export interface SimContext {
  ...
  /**
   * SL約定価格のイントラバー・モデル（全戦略に適用）。
   * 未指定時は "end-of-bar" = 現行挙動（baseline 完全不変）。--compare-intrabar 検証用。
   */
...
function processExits(
  ...
  intraBarStopModel: IntraBarStopModel = "end-of-bar",
): void {
