...
| **リスク管理** | ATRベースの機械的損切り、1トレードあたりリスク2%、連敗時のポジション縮小、VIX>30 / 日経・CMEキルスイッチでディフェンシブ決済（position-monitor 15:20まで） |
...
| 時刻 | ジョブ | 内容 |
|------|--------|------|
| 17:00 | end-of-day | 期限切れ注文キャンセル、日次サマリー作成、AI日次レビュー、crisis時の未決済ポジション残存検知 |
